...
export const ModalEditarEmpleadoMoible = ({ idObtenida }) => {
  ...
  const onSubmit = async (formData) => {
    try {
      ...
      document.getElementById("my_modal_editar_empleado_mobile").close();
    } catch (error) {
  ...
  return (
    <dialog id="my_modal_editar_empleado_mobile" className="modal">
