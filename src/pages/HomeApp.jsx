...
export function HomeApp() {
  ...
  return (
    <section className="mx-10 my-10 max-md:mx-5">
      ...
      <div className="mt-6 mb-10 grid grid-cols-4 gap-5 bg-white max-md:grid-cols-1 max-md:gap-0">
      ...
      <div className="transition-all ease-linear cursor-pointer bg-white py-5 px-5 flex">
        <Link
          ...
          className="bg-blue-500 py-1 px-4 rounded-full text-white font-semibold flex gap-2 items-center max-md:text-sm"
        >
      ...
      <div className="mt-5 transition-all ease-linear cursor-pointer bg-white py-5 px-5 max-md:overflow-x-auto">
        ...
        <form
          className="py-3 px-5 border-[1px] border-slate-300 mb-6 mx-5 flex gap-5 max-md:flex-col max-md:border-none"
          onSubmit={(e) => {
            e.preventDefault();
            agregarFila();
          }}
      ...
      <div className="py-5 px-5 cursor-pointer mt-5 transition-all ease-in-out bg-white max-md:overflow-x-auto">
        ...
        <form
          className="py-3 px-5 border-[1px] mb-6 mx-5 flex gap-5 mt-10 max-md:flex-col max-md:border-none"
          onSubmit={(e) => {
            e.preventDefault();
            agregarFilaCanjes();
          }}
